...
fn projects() -> Vec<Project> {
    vec![
        ...
        Project {
            ...
            description_en: "A hyper-minimalist Pomodoro timer and productivity tracker built natively in Rust and WebAssembly, featuring a distraction-free Monastic design",
            description_pt: "Um cronômetro Pomodoro e rastreador de produtividade, desenvolvido nativamente em Rust e WebAssembly, com um design Monastic que elimina distrações",
            links: &[
